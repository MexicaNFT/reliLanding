  ...
  return (
    <div className="px-4 sm:px-6 md:px-8 py-2 md:py-2 flex flex-col justify-center">
      <div className="container mx-auto flex flex-col items-center justify-center">
        <WelcomeBanner text="¿Por qué Reli?" />
        <text className="font-poopins text-[25px] sm:text-[30px] md:text-[36px] lg:text-[38px] leading-tight md:leading-tight text-center mb-10 text-[#36454F] max-w-4xl mx-auto">
          Reli hace lo tedioso de tu <br className="hidden sm:block" /> práctica
          legal, para que tú <br className="hidden sm:block" />
          te dediques a lo importante.
        </text>
      </div>
    </div>
  );
