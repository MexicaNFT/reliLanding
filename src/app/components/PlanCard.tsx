...
const Card: React.FC<CardProps> = ({
  ...
  return (
    <div className="bg-white p-6 h-[448px] w-[296px] max-w-[320px] rounded-2xl flex flex-col shadow-sm transition-shadow duration-200 hover:shadow-md border border-[#E6E6E6]">
