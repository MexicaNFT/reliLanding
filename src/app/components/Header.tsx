    ...
    <div>
      <header className="flex items-center justify-between px-4 py-4 bg-white shadow-md">
        ...
        <div className="hidden md:flex items-center space-x-4">
          <button className="bg-[#34C1A6] text-white px-4 py-2 rounded-full hover:bg-opacity-90 shadow-md transition-colors">
            Sign In
          </button>
          <button className="bg-white border border-[#E5E7EB] shadow-md text-gray-600 px-4 py-2 rounded-full hover:bg-gray-100 transition-colors">
            Contact-Us
          </button>
        </div>
      </header>
