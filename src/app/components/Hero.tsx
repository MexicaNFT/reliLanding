...
export default function Hero() {
  return (
    <section className="py-10 md:py-20 bg-gradient-to-b from-white via-[#DCF5F0] via-60% to-[#1ABC9C]">
      <div className="container mx-auto px-4 mt-20">
        <div className="flex justify-center gap-x-1 bg-white p-2 rounded-full w-max mx-auto ">
          <Image
          ...
          />
          <h1 className="text-[#1ABC9C] text-xl font-semibold">
            Welcome to Reli
          </h1>
        </div>
        <h1 className="font-poppins font-bold text-3xl sm:text-4xl md:text-5xl lg:text-[58px] leading-tight md:leading-[110px] text-center mb-4 md:mb-6 text-[#36454F] py-0">
          La Solución #1 de Abogados <br />
          de Bolsillo en México
        </h1>

        <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-24 md:mb-40 my-24">
          <button
            className="w-48 sm:w-auto font-poppins text-xs sm:text-sm font-normal leading-5 sm:leading-6  py-2 sm:px-8 sm:py-3 bg-[#34C1A6] text-white border border-[#34C1A6] rounded-full hover:bg-[#2ca089] transition duration-300 px-8"
