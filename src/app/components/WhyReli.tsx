...
export default function WhyReli() {
  return (
    <section id="why-reli" className="bg-neutral-100 h-[438px] relative">
      <div className="max-w-[1440px] mx-auto px-4 lg:px-[120px] pt-[120px]">
        {/* Section Badge */}
        <div className="flex justify-center mb-[106px]">
        ...
        <div className="max-w-[996px] mx-auto text-center">
          <p className="font-inter font-normal text-[36px] leading-[46px] text-[#36454f]">
